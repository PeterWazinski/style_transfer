...
from src.ui.widgets.thumbnail_delegate import ThumbnailDelegate
...
class StyleGalleryView(QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        # --- Button row ---
        btn_row = QHBoxLayout()
        self.add_button: QPushButton = QPushButton("+ Add Style", self)
        self.delete_button: QPushButton = QPushButton("– Delete", self)
